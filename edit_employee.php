        ...
        if (isset($_FILES['profile_img']) && $_FILES['profile_img']['error'] === 0) {
            ...
            if (!in_array($_FILES['profile_img']['type'], $allowed_types)) {
                ...
                if (move_uploaded_file($_FILES['profile_img']['tmp_name'], $upload_path)) {
                    ...
                    if ($row['m_img'] && file_exists($row['m_img']) && 
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control <?php echo isset($errors['start_date']) ? 'is-invalid' : ''; ?>" 
                                       name="start_date" value="<?php echo htmlspecialchars($employee['start_date']); ?>" required>
                                <?php if (isset($errors['start_date'])): ?>
                                    <div class="error-message"><?php echo htmlspecialchars($errors['start_date']); ?></div>
                                <?php endif; ?>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>เงินเดือน (บาท) <span class="required">*</span></label>
                                <input type="number" class="form-control <?php echo isset($errors['salary']) ? 'is-invalid' : ''; ?>" 
                                       name="salary" value="<?php echo htmlspecialchars($employee['salary']); ?>" required>
                                <?php if (isset($errors['salary'])): ?>
                                    <div class="error-message"><?php echo htmlspecialchars($errors['salary']); ?></div>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
