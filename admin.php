...
<body>
    ...
    <ul class="navbar-nav ml-auto admin-nav">
        <li class="nav-item">
            <a class="nav-link" href="employee_list.php">
                <i class="fas fa-users"></i>พนักงานทั้งหมด
            </a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
            <a class="nav-link" href="all_employee_time.php">
                <i class="fas fa-clipboard-list"></i>รายงานการมาทำงาน
            </a>
        </li>
        <li class="nav-item">
